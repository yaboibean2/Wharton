...
class AIPortfolioSelector:
    ...
    def select_portfolio_tickers(
        ...
        logger.info("📊 Stage 1: OpenAI Ticker Selection")
        ...
        logger.info("📊 Stage 2: Perplexity Ticker Selection")
        ...
        logger.info(f"   → Perplexity: {len(perplexity_tickers)} tickers")
        ...
        logger.info("📊 Stage 5: OpenAI Final Selection (3 rounds)")
...
"""
        ...
        try:
            ...
            logger.info(f"✅ OpenAI selected {len(tickers)} tickers")
            return tickers, log
            
        except Exception as e:
            logger.error(f"❌ OpenAI selection failed: {e}")
...
"""
        ...
        try:
            ...
            logger.info(f"✅ Perplexity selected {len(tickers)} tickers")
            return tickers, log
            
        except Exception as e:
            logger.error(f"❌ Perplexity selection failed: {e}")
